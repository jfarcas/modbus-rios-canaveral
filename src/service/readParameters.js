        ...
        descriptions: [
            {
                ...
                multiplier: 1,
                hasAlarm: function (value) { return value > 100000; },
                state: function (value) { return value > 100000 ? 'Error' : 'Ok'; },
                showOnScreen: false,
            },
            {
                description: 'Consigna Temperatura caldera 1',
                multiplier: 1,
                hasAlarm: function (value) { return value > 10000; },
                state: function (value) { return value > 100000 ? 'Error' : 'Ok'; },
                showOnScreen: false,
            },
            {
            ...
            },
            {
                ...
                multiplier: 1,
                hasAlarm: function (value) {
                    console.log(value);
                    return value === 0 || value === 11;
                },
                state: function (value) { return boilerState[value]; },
                showOnScreen: true,
            },
            {
        ...
        descriptions: [
            {
                ...
                multiplier: 1,
                hasAlarm: function (value) { return value < 50; },
                state: function (value) { return value < 50 ? 'Error' : 'Ok'; },
                showOnScreen: true,
            },
            {
                ...
                multiplier: 1,
                hasAlarm: function (value) { return value > 10000; },
                state: function (value) { return value < -1 ? 'Error' : 'Ok'; },
                showOnScreen: true,
            }
        ]
    },
